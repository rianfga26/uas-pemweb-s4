...
@section('content')
<div class="flex flex-col px-5 md:px-56 lg:px-80 mt-5 mb-10 justify-start">
        <p class="font-bold mb-3 mt-2">Unit Bisnis</p>
        <p class="font-medium capitalize text-2xl lg:text-4xl mb-6">si pinter keuangan jatim</p>
