...
@section('title', "Galeri Investasi Syari'ah ")
@section('content')
<!-- konten -->
<div class="flex flex-col px-5 md:px-56 lg:px-84 mt-5 mb-10 justify-start">
        <p class="mb-3 mt-2 font-bold">Unit Bisnis</p>
        <p class="font-medium capitalize text-2xl lg:text-4xl mb-6">Galeri investasi syari'ah</p>
